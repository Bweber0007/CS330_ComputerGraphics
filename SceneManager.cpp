...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("directionalLight.position", 5.0f, 10.0f, 1.0f);
	...
	// point light
	m_pShaderManager->setVec3Value("pointLights[0].position", -40.0f, 13.0f, 13.0f);
	m_pShaderManager->setVec3Value("pointLights[0].ambient", 0.05f, 0.05f, 0.05f);
	m_pShaderManager->setVec3Value("pointLights[0].diffuse", 1.0f, 0.3f, 0.3f);
...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture("yellow.jpg", "gold");

	bReturn = CreateGLTexture("metal.jpg", "metal");

	bReturn = CreateGLTexture("wood.jpg", "wood");

	bReturn = CreateGLTexture("glass.jpg", "glass");

	bReturn = CreateGLTexture("black.jpg", "black");
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(40.0f, 0.0f, -5.0f);
	...
	/*** Draw silver top ring					***/
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(2.5f, 2.5f, 8.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(40.0f, 5.0f, -5.0f);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.15f, 15.0f, 0.15f);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(3.0f, 15.0f, 2.0f);
	...
	/****************************************************************/
	/*** Draw monitor stand neck swivel						***/
	/******************************************************************/
	// set the XYZ scale for the mesh
...
// set the XYZ scale for the mesh
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 15.0f, -4.5f);
	...
	/****************************************************************/
/*** Draw monitor lighting screen				***/
/******************************************************************/
// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(38.0f, 18.0f, 0.1f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 15.0f, -3.5f);
...
// set the XYZ scale for the mesh
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-45.0f, 0.0f, -6.0f);
...
/******************************************************************/
// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.5f, 15.0f, 0.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-45.0f, 2.0f, -6.0f);
...
// set the XYZ scale for the mesh
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-55.6f, 12.6f, -6.0f);
...
// set the XYZ scale for the mesh
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-45.0f, 2.0f, -6.5f);
...
// set the XYZ scale for the mesh
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-55.6f, 12.6f, -6.5f);
...
// set the XYZ scale for the mesh
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-34.3f, 18.6f, -6.0f);
...
// set the XYZ scale for the mesh
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-25.0f, 0.0f, 8.0f);
...
/******************************************************************/
// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.2f, 1.9f, 1.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-26.0f, 3.2f, 10.5f);
